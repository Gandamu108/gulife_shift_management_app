...
class EditingPage extends StatefulWidget {
  EditingPage({Key? key, required this.title, required this.events}) : super(key: key);
...
class _EditingPageState extends State<EditingPage> {
  ...
  void _saveData() async {
    ...
    await sendEventToSheet(widget.events, userEmail); // widget.eventsを送信
